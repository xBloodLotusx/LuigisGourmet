...
import dishMarsala from "@/assets/dish-marsala.jpg";
import dishParmigiana from "@/assets/dish-parmigiana.jpg";
import dishGenovese from "@/assets/dish-genovese.jpg";
import dishJeffreys from "@/assets/dish-jeffreys.jpg";
import aboutBreadWine from "@/assets/about-bread-wine.jpg";
import galleryBar from "@/assets/gallery-bar.jpg";
import galleryLasagna from "@/assets/gallery-lasagna.jpg";
import galleryBread from "@/assets/gallery-bread.jpg";
import galleryTiramisu from "@/assets/gallery-tiramisu.jpg";
...
const dishes = [
  { name: "Chicken Marsala", img: dishMarsala, desc: "Sautéed mushrooms in a rich Marsala wine sauce, served over creamy mashed potatoes." },
  { name: "Chicken Parmigiana", img: dishParmigiana, desc: "Golden breaded chicken topped with house marinara and mozzarella over spaghetti." },
  { name: "Chicken Genovese", img: dishGenovese, desc: "Tender chicken with asparagus, mozzarella, alfredo and marinara over spaghetti." },
  { name: "Jeffrey's Special", img: dishJeffreys, desc: "Meatballs, sausage, peppers, mushrooms & mozzarella tossed with penne." },
];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="top" className="relative h-[88vh] min-h-[560px] w-full overflow-hidden">
        <img
          src={heroDining}
          alt="Warm candlelit dining room at Luigi's Gourmet Italian Restaurant in Roanoke"
          width={1920}
          height={1280}
      ...
      <section id="about" className="py-20 md:py-28 container">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="fade-in-up relative">
            ...
            <img
              src={aboutBreadWine}
              alt="Rustic Italian bread, red wine, and olive oil on a wooden table"
              loading="lazy"
              width={1280}
              height={1280}
      ...
      <section id="gallery" className="py-20 md:py-28 container">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          <img src={heroDining} alt="Dining room" loading="lazy" width={1920} height={1280} className="rounded-lg object-cover aspect-[3/4] md:row-span-2 md:aspect-auto md:h-full w-full fade-in-up" />
          <img src={galleryBar} alt="Full bar at Luigi's" loading="lazy" width={1280} height={960} className="rounded-lg object-cover aspect-square w-full fade-in-up" />
          ...
          <img src={dishMarsala} alt="Chicken Marsala" loading="lazy" width={1024} height={1024} className="rounded-lg object-cover aspect-square md:col-span-2 md:aspect-[2/1] w-full fade-in-up" />
          <img src={galleryBread} alt="Garlic bread" loading="lazy" width={1024} height={1024} className="rounded-lg object-cover aspect-square w-full fade-in-up" />
          <img src={galleryTiramisu} alt="Tiramisu dessert" loading="lazy" width={1024} height={1024} className="rounded-lg object-cover aspect-square w-full fade-in-up" />
        </div>
      </section>
